...
//If the array does not contain "chocolate", add "chocola te".
//doubleCheck should return the array.

//Code Here
function doubleCheck(arr) {
if (arr !== 'chocolate') {arr.push('chocolate')
return arr;
  }else{
return arr;}
}
...
//Code Here
var dog = {name: 'Brad', color: 'Blue', age: 36, goodBoy: true};
...
//Code Here
function outerFn() {var inner = function () {return "brad"};
return inner;}
